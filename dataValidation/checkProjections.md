...
Additionally, there are two optional datasets you can use in Projections:
1. Tracts
2. Assessor Data
...
* Check ALL eligible "Other Attribute fields" *
  * Validate no double values in fields (warning only)
  * Validate no special characters in fields (warning only)
...
## Tracts
* Validate contains field STDYAREA, and field type is Text.
* Validate contains field TRACTNUM_, and field type is Short Integer
* Validate contains field TYPE, and field type is Text
* Validate contains field PH1_, and field type is Short Integer
* Validate contains field PH1_COMP, and field type is Date
* Validate contains field PH2_, and field type is Short Integer
* Validate contains field PH2_COMP, and field type is Date
* Validate contains field PH3_, and field type is Short Integer
* Validate contains field PH3_COMP, and field type is Date
* Validate contains field PH4_, and field type is Short Integer
* Validate contains field PH4_COMP, and field type is Date
* Validate contains field PH5_, and field type is Short Integer
* Validate contains field PH5_COMP, and field type is Date
* Validate contains field PH6_, and field type is Short Integer
* Validate contains field PH6_COMP, and field type is Date
* Validate contains field PH7_, and field type is Short Integer
* Validate contains field PH7_COMP, and field type is Date
* Validate contains field PH8_, and field type is Short Integer
* Validate contains field PH8_COMP, and field type is Date
* Validate contains field PH9_, and field type is Short Integer
* Validate contains field PH9_COMP, and field type is Date
* Validate contains field PH10_, and field type is Short Integer
* Validate contains field PH10_COMP, and field type is Date
* Check fields STDYAREA, TRACTNUM, TYPE and PH1_ thru PH10_
  * Validate no NULL values in these fields
  * Validate no special characters in these fields

## Assessor
* Validate user selected a field containing the "Housing Ty pe", and field type is Text
* Validate user selected a field containing the "Total Units", and field type is Short Integer
* Check fields "Housing Type and "Total Units"
  * Validate no NULL values in these fields
  * Validate no special characters in these fields
