...
<table>
<TR>
      <TH COLSPAN="5"><H3>Student Types used in Redistricting Plans </br> (for students with grades -1 through 12)</H3>
      </TH>
   </TR>
  <tr>
    <th>Code</th>
 ...
 *Inherited indicates that student type will be included if the residential projection included that optional type during setup. 
 ...
 <table>
<TR>
      <TH COLSPAN="5"><H3>Student Types used in Projections </br>
